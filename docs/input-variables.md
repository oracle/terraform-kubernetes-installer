...
master_oci_lb_enabled               | true                    | enable/disable the k8s master oci load balancer. true: use oci load balancer for k8s master . false: use nginx reverse proxy as a software load balancer for k8s masters.
